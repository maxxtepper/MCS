...
//This file does the same thing as mcs_rawInput_M.C, except it can except multiple amounts of layers,
//and will process all runs available, based on the naming scheme, for all layers given.
//
